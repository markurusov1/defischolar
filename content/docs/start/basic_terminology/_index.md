...
---
{{< icons/icon vendor=lucide name=network size="30">}}
## Networks 
{{% hint success %}} 
...
{{< icons/icon vendor=lucide name=link-2 size="30">}}
## Blockchain 
{{% hint info %}}
...
- Each of these networks uses a specific token – Bitcoin is a token, the NFTs, mem coins, stablecoins - all these 
things are tokens 
- Some algorithms have to with cryptography, which is why people refer to blockchain tokens as 
“cryptocurrency” or just “crypto”
{{% /hint %}}

{{< icons/icon vendor=lucide name=arrow-left-right size="30">}}
...
{{< icons/icon vendor=lucide name=bitcoin size="30">}}
## The "FI" in DeFi 
{{% hint info %}}
...
- They are: __exchange, liquidity and pool__
